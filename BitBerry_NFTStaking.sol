...
contract Bit_Berry_NFT_Staking is Ownable {
    ...
    address public defaultRefferal=msg.sender;
    ...
    constructor(IERC20 _tokenaddr, IERC721 _nftaddr) {
        ...
        allocation[180] = 1000000000000000000; //1% daily profit
         refferalStatus[defaultRefferal]=true;
    }

    function checkOwner(uint256 _tokenID)
        public
        view
    ...
    function farm(uint256 _lockableDays, uint256  _tokenID ,address refferal)
        public
        whenNotPaused
    {
        ...
        require(refferalStatus[refferal]== true,"please enter correct refferal");
